...
export const Toolbar: React.FC<ToolbarProps> = ({
    ...
    return (
        <div className="flex items-center px-4 py-2 relative z-50 overflow-x-auto hide-scrollbar whitespace-nowrap"
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="relative">
                    ...
                    {batchOpen && (
                        <div className="fixed md:absolute top-[120px] md:top-full left-1/2 md:left-0 -translate-x-1/2 md:translate-x-0 mt-1 z-[60] py-1 rounded-lg shadow-2xl"
                ...
                {/* Progress */}
                {hasData && (
                    <div className="flex items-center gap-2 border-l border-r px-4" style={{ borderColor: 'var(--color-border)' }}>
                ...
                >
                    {isSaving ? <Loader2 className="animate-spin" size={14} /> : <CheckSquare size={14} />}
                ...
                <div className="relative">
                    ...
                    {downloadOpen && (
                        <div className="fixed md:absolute top-[120px] md:top-full right-4 md:right-0 mt-1 z-[60] py-1 rounded-lg shadow-2xl"
            ...
            {(downloadOpen || batchOpen) && (
                <div className="fixed inset-0 z-[55]" onClick={() => { setDownloadOpen(false); setBatchOpen(false); }} />
            )}
        </div>
    );
};
